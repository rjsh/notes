...
<a id='f1'></a>
![Figure 1: OMX Core Initialization](f1.jpg "Figure 1: OMX Core Initialization")
...
<a id='f2'></a>
![Figure 2: OMX component instantiation through `OMX_GetHandle`](f2.jpg "Figure 2: OMX component instantiation through OMX_GetHandle")
...
<a id='f3'></a>
![Figure 3: OMX component parameter negotiation](f3.jpg "Figure 3: OMX component parameter negotiation")
...
<a id='f4'></a>
![Figure 4: OMX component state transition from `OMX_StateLoaded` to `OMX_StateIdle`](f4.jpg "Figure 4: OMX component state transition from OMX_StateLoaded to OMX_StateIdle")
...
<a id='f5'></a>
![Figure 5: OMX component state transition from `OMX_StateIdle` to `OMX_StateExecuting` and data exchange](f5.jpg "Figure 5: OMX component state transition from OMX_StateIdle to OMX_StateExecuting and data exchange")
...
<a id='f6'></a>
![Figure 6: OMX component state transition from `OMX_StateExecuting` to `OMX_StatePause` and back](f6.jpg "Figure 6: OMX component state transition from OMX_StateExecuting to OMX_StatePause and back")
...
<a id='f7'></a>
![Figure 7: OMX component port flush procedure](f7.jpg "Figure 7: OMX component port flush procedure")
...
<a id='f8'></a>
![Figure 8: OMX component state transition from `OMX_StateExecuting/Paused` to `OMX_StateIdle`](f8.jpg "Figure 8: OMX component state transition from OMX_StateExecuting/Paused to OMX_StateIdle")
...
<a id='f9'></a>
![Figure 9: OMX component state transition from `OMX_StateIdle` to `OMX_StateLoaded`](f9.jpg "Figure 9: OMX component state transition from OMX_StateIdle to OMX_StateLoaded")
